...
#define log_fatal(msg) log_fatal_internal(msg, __FILE__, __LINE__)

#define log_errno(msg) log_errno_internal(msg, errno, __FILE__, __LINE__)
#define log_assert(EXPR) \
	log_assert_internal(EXPR, STRING(EXPR), __FILE__, __LINE__)
...
extern void
log_assert_internal(bool assertion, char *expression, char *file, int line);
